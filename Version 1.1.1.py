...
def show_score_window():
    ...
    name_label = tk.Label(score_win, text=f"{user_name}", font=("Adamina", 15), fg="white", bg='#001122' )
    name_label.place(relx=0.5, rely=0.42, anchor="center")

    #Score Display
    score_display = tk.Label(score_win, text=f"YOUR SCORE", font=("Adamina", 15), fg="white", bg='#001122' )
    score_display.place(relx=0.5, rely=0.49, anchor="center")
    
    #Score Display
    s_display = tk.Label(score_win, text=f" {score} / {len(easy_questions)}", font=("Adamina", 15), fg="white", bg='#001122' )
    ...
    restart_btn = tk.Button(score_win, text="RESTART", font=("Nico Moji", 18), command=easy_restart_quiz, fg="white", bg='#001122')
    restart_btn.place(relx=0.28, rely=0.60, relwidth=0.14, relheight=0.09)

    continue_btn = tk.Button(score_win, text="CONTINUE", font=("Nico Moji", 18), command=continue_quiz, fg="white", bg='#001122')
    continue_btn.place(relx=0.59, rely=0.60, relwidth=0.16, relheight=0.09)

    exit_btn = tk.Button(score_win, text="EXIT", font=("Nico Moji", 18), fg="white", bg='#001122', command=exit_quiz)
