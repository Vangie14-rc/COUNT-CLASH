...
hard_questions = [
    {"question": "If 3x + 5 = 14, what is the value of x?", "answer": "3"},
    {"question": "Ben pays $40 per month to attend a weekly yoga class. His sister Ilene gets a discount at her yoga class and pays $35 per month. Over the course of one year, how much more money does Ben pay a year to attend his yoga class?", "answer": "60"},
    {"question": "Solve for y in the equation: y - 13 = -3", "answer": "10"},
    {"question": "If p m q = p + q + p/q, the value of 8 m 2 is:", "answer": "14"},
    {"question": "Simplify the expression: 4(2x - 3) + 2(x + 5)", "answer": "10x - 2"},
    {"question": "Y = 27j - 7 - 7j. If y = 13, what will j be equal to?", "answer": "1"},
    {"question": "Solve for y: 2(y - 4) = 3(y + 2)?", "answer": "-14"},
    {"question": "What is the slope of the line represented by the equation y = -2x + 5?", "answer": "-2"},
    {"question": "If a * b = 2 (a + b), then 5 * 2 is equal to:", "answer": "14"},
    {"question": "What is the slope of a straight line that connects the following points.(1,2) & (4,11)", "answer": "3"},
]
#*********************HARD QUIZ WINDOW**********************************
def open_hard_quiz():
    global score
    ...
    def check_answer():
        ...
        hard_win.after(1000, next_question)
    ...
    answer_entry.place(relx=0.5, rely=0.47, relwidth=0.18, anchor="center") 
...
def show_score_hard_window():
    ...
    #Name display  
    name_label = tk.Label(score_hard_win, text=f"{user_name}", font=("Adamina", 15), fg="white", bg='#001122' )
    name_label.place(relx=0.5, rely=0.42, anchor="center")

    #Text label "YOUR SCORE"
    score_display = tk.Label(score_hard_win, text=f"YOUR SCORE", font=("Adamina", 15), fg="white", bg='#001122' )
    score_display.place(relx=0.5, rely=0.49, anchor="center")
    
    #Score value
    s_display = tk.Label(score_hard_win, text=f" {score} / {len(easy_questions)}", font=("Adamina", 15), fg="white", bg='#001122' )
